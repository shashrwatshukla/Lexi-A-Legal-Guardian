...
**Lexi is your complete AI Legal Co-Pilot** - demystifying legal documents and empowering individuals to understand contracts without expensive legal fees.
...
Lexi is a **fully-functional, production-ready AI legal platform** built with **Next.js 14** and powered by **Google Cloud AI Suite** (Gemini & Vertex AI). It provides an end-to-end legal document management ecosystem that transforms complex legal jargon into simple, understandable language.

**What Lexi Does:**
- 🔍 **Analyzes** legal documents with deep AI-powered insights, risk assessment, and clause-by-clause breakdowns
- ✍️ **Drafts** country-specific legal contracts in seconds from plain language descriptions
- 💬 **Explains** legal terms through an intelligent, context-aware AI chatbot that understands your documents
- 📊 **Manages** your complete document lifecycle with secure cloud storage and full data control

Built for **freelancers, startups, small businesses, and individuals** who need to understand legal agreements without the high cost of legal consultations.
...
Deep contextual analysis powered by Google Gemini & Vertex AI
...
![Analysis Demo](https://user-images.githubusercontent.com/74038190/212750147-854a394f-fee9-4080-9770-78a4b7ece53f.gif)
...
- ✅ **195+ Countries**: Select any country for jurisdiction-specific compliance
- ⚖️ **Local Laws Integration**: Automatic compliance with regional legal requirements
- 🎤 **Voice-to-Text Input**: Describe contracts naturally by speaking
- ⌨️ **Text Input**: Traditional text-based contract description
- 📄 **Professional PDF Output**: Download ready-to-use, formatted contracts
- ⚡ **20-Second Generation**: Lightning-fast AI drafting
- 📊 **Estimated Page Count**: Preview document size before generation

#### **📋 Supported Contract Types**
```
✅ Non-Disclosure Agreements (NDA)        ✅ Service Agreements
✅ Employment Contracts                   ✅ Freelance Contracts
✅ Partnership Agreements                 ✅ Rental/Lease Agreements
✅ Vendor Contracts                       ✅ Consulting Agreements
...
- 📄 **Document Context Awareness**: Remembers and understands uploaded content
- 🎙️ **Voice Input**: Speak your questions naturally
- 🔊 **Audio Responses**: Listen to answers (text-to-speech)
- 💡 **Smart Suggestions**: Proactive negotiation tips and clause recommendations
- 🔍 **Deep Search**: Find specific clauses or terms instantly
- 🎯 **Contextual Answers**: Responses tailored to your specific document
- 📚 **Legal Knowledge Base**: General legal questions answered
- 🌐 **Multi-Language Support**: Ask in any of 20 supported languages
...
❓ "Can I negotiate the liability terms?"
❓ "Summarize page 3 in simple terms"
❓ "What clauses are missing from this NDA?"
```
...
- **📊 Visual Statistics Cards**: Beautiful, at-a-glance metrics with progress indicators
...
│   │   ├── how-it-works/               # Process flow images
│   │   └── *.png                       # UI images
│   ├── 🎬 media/
│   │   ├── encryption-bg.webm          # Background videos
│   │   └── Templates-page.png
...
│   │   │   ├── chatbot/route.js        # AI Chatbot endpoint
│   │   │   ├── document-process/       # Document analysis API
│   │   │   ├── draft-generate/         # Contract generation API
│   │   │   ├── detailed-summary/       # Summary generation
│   │   │   ├── generate-voice/         # Text-to-speech API
│   │   │   └── share-session/          # Session sharing
│   │   │
│   │   ├── 🔐 auth/page.jsx            # Authentication page
│   │   ├── 📊 dashboard/page.jsx       # Main dashboard
│   │   ├── ✍️ drafter/                 # Contract drafter
│   │   ├── ⚙️ settings/page.jsx         # User settings
│   │   ├── 🔗 share/[sessionId]/       # Shared analysis view
│   │   └── 🏠 intro/page.jsx            # Landing page
│   │
...
│   │
│   ├── 📂 lib/                         # Business Logic
│   │   ├── 🤖 drafter/                 # Drafting Engine
│   │   ├── 🔍 legalAnalyzer.js         # Core analysis
...
```env
# Google Gemini API (AI Analysis & Drafting)
...
# Google Cloud (Cloud Functions & Services)
...
| **Google Cloud** | [GCP Console](https://console.cloud.google.com/) |
...
- **React 18**: Component library with Hooks & Context API
...
- **Google Gemini Pro**: Advanced legal text analysis
- **Google Vertex AI**: Multi-modal AI capabilities
- **Custom Prompt Engineering**: Optimized legal prompts

#### **Database & Storage**
- **Google Cloud Firestore**: NoSQL document database
- **Firebase Cloud Storage**: File storage (1GB per user)
...
- ✅ **Secure Transmission** - TLS 1.3 in transit
...
- 🐛 **Bug Reports**: [GitHub Issues](https://github.com/shashrwatshukla/Lexi-A-Legal-Guardian/issues)
...
| Technology | Purpose |
|------------|---------|
| 🤖 **Google Gemini & Vertex AI** | Advanced legal AI capabilities |
| ☁️ **Google Cloud Platform** | Reliable cloud infrastructure |
| 🔥 **Firebase** | Authentication & Database |
| ⚛️ **Next.js & React** | Amazing developer experience |
...
[![Fork Repository](https://img.shields.io/badge/🔱_Fork_Repository-00AA00?style=for-the-badge&logo=git&logoColor=white)](https://github.com/shashrwatshukla/Lexi-A-Legal-Guardian/fork)

---

### **📱 Connect With Us**

[🌐 Website](https://asklexi.vercel.app) • 
[📖 Documentation](https://asklexi.vercel.app/FooterComponents/docs) • 
[💬 FAQ](https://asklexi.vercel.app/faq) • 
[📧 Contact](https://asklexi.vercel.app/FooterComponents/contact)
